##Punto 1
##Algoritmos subsecuencia más larga ordenada de números en un arreglo
import time
## -------------------------------------------------------------------------
##Solucion Eficiente
## -------------------------------------------------------------------------
##LongestOrderedSecuence: Encuentra la subsecuencia más larga ordenada de números
##de un arreglo.
##Entradas:
##	- S: secuencia
##Salidas:
##	- indice del elemento minimo e indice del elemento maximo dentro de la secuecia
## -------------------------------------------------------------------------
def LongestOrderedSecuence(S):
    return LongestOrderedSecuence_Helper(S,0,len(S)-1)
##end def

## -------------------------------------------------------------------------
##LongestOrderedSecuence_Center: Función que busca la subsecuencia con el pivote
##incluido
##Entradas:
##	- S: secuencia
##	- i: indice inicio secuencia
##  - f: indice fin secuencia
##  - q: pivote de la secuencia
##Salidas:
##	- indices: indice del elemento minimo e indice del elemento maximo dentro
##              de la secuencia
## -------------------------------------------------------------------------
def LongestOrderedSecuence_Center(S,i,f,q):
    indices=[]
    aux=q
    while q-1>=i and S[q-1]<S[q] :
        q=q-1
    ##end while
    indices.append(q)
    q=aux
    while q+1<=f and S[q+1]>S[q] :
        q=q+1
    ##end while
    indices.append(q)
    return indices
...
## -------------------------------------------------------------------------
##LongestOrderedSecuence_Helper: Función auxiliar que busca la subsecuencia
##más larga ordenada de números en la secuencia.
##Entradas:
##	- S: secuencia
##	- i: indice inicio secuencia
##  - f: indice fin secuencia
...
##              de la secuencia
## -------------------------------------------------------------------------
def LongestOrderedSecuence_Helper(S,i,f):
    indices=[]
    if i==f:    #Caso Base
        indices.append(i)
        indices.append(f)
    ...
    ##end if
        ...
        q=int((f+i)/2)
        left,right,center=[],[],[]
        left=LongestOrderedSecuence_Helper(S,i,q)
        right=LongestOrderedSecuence_Helper(S,q+1,f)
        center=LongestOrderedSecuence_Center(S,i,f,q)
        if right[1]-right[0]<=left[1]-left[0] and center[1]-center[0]<=left[1]-left[0]:
            return left
        #end if
        elif left[1]-left[0]<=right[1]-right[0] and center[1]-center[0]<=right[1]-right[0]:
            return right
        ##end elif
        else:
            return center
...
##Solucion Evidente
## -------------------------------------------------------------------------
##LargestOrderedSecuenceEvident: Encuentra la subsecuencia más larga ordenada
## de números de un arreglo.
##Entradas:
##	- S: secuencia
##Salidas:
##	- indice del elemento minimo e indice del elemento maximo dentro de la
##     secuencia.
## -------------------------------------------------------------------------

def LargestOrderedSecuenceEvident(S):
    return LargestOrderedSecuenceEvident_Helper(S,0,len(S)-1)
##end def

## -------------------------------------------------------------------------
##LargestOrderedSecuenceEvident_Helper: Función auxiliar que encuentra la
##subsecuencia más larga ordenada de números de un arreglo.
##Entradas:
##	- S: secuencia
##  - b: índice de inicio
##  - f: índice de final
...
##     secuencia.
## -------------------------------------------------------------------------
def LargestOrderedSecuenceEvident_Helper(S,b,f):
   tam=0
   tam_aux=0
   ind=[]
   for i in range(b,f):
